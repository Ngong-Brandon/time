...
function apiSearchResults(countryToBeSearch){
    ...
    <main class="nav-header">
        ...
        <nav class="nav-item">
            <a onclick = "location.reload()" href="australia.html#ourservices">Home</a>
        </nav>
        <nav class="nav-item">
            <a onclick = "location.reload()" href="australia.html#country">Your Country</a>
        </nav>
       
        <nav class="nav-item">
            <a onclick = "location.reload()" href="australia.html#contact">Contact Us</a>
        </nav>
        <nav>
...
<main class="mobile-menu cursive" id="menu">
    ...
    <nav>
        ...
        <i class="fa-solid fa-home"></i><a onclick = "location.reload()" href="australia.html">Home</a>

    </nav>

    <br>
    <nav>
        <i class="fa-solid fa-globe "></i><a onclick = "location.reload()" href="australia.html#country">Your Country</a>
    ...
    <nav>
        <i class="fa-solid fa-phone"></i> <a onclick = "location.reload()" href="australia.html#contact">Contact Us</a>
...
function makeAlert(error){
 ...
 async function apiResults(City){
   await  fetch(`https://worldtimeapi.org/api/timezone/Australia/${City}`).then((response)=>{
